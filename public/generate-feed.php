<?php
// public/generate-feed.php

// 1. Récupérer le JSON de votre API
$json = @file_get_contents('https://medhant.devaito.com/api/fetch-all-products');
$data = json_decode($json, true);
if (empty($data['products'])) {
    header('HTTP/1.1 500 Internal Server Error');
    echo 'Erreur : produits introuvables';
    exit;
}

// 2. Construire le flux XML Google Merchant Center
...
$channel->addChild('link', 'https://medhant.devaito.com/');
